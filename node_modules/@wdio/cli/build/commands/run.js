...
async function handler(argv) {
    ...
    if (!fs_extra_1.default.existsSync(configPath)) {
        await config_1.missingConfigurationPrompt('run', `No WebdriverIO configuration found in "${configPath}"`);
    }
    const localConf = path_1.default.join(process.cwd(), 'wdio.conf.js');
    const wdioConf = configPath || (fs_extra_1.default.existsSync(localConf) ? localConf : null);
    if (params.watch) {
