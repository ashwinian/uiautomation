...
class Launcher {
    constructor(configFilePath, args = {}, isWatchMode = false) {
        ...
        this.interface = new interface_1.default(config, totalWorkerCnt, this.isWatchMode);
    ...
    async run() {
        ...
        try {
            ...
            await utils_2.runServiceHook(this.launcher, 'onPrepare', config, caps);
            exitCode = await this.runMode(config, caps);
            log.info('Run onComplete hook');
            await utils_2.runServiceHook(this.launcher, 'onComplete', exitCode, config, caps);
    ...
    async startInstance(specs, caps, cid, rid, retries) {
        ...
        await utils_2.runLauncherHook(config.onWorkerStart, cid, caps, specs, this.args, execArgv);
        await utils_2.runServiceHook(this.launcher, 'onWorkerStart', cid, caps, specs, this.args, execArgv);
