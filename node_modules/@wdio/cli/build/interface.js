...
class WDIOCLInterface extends events_1.default {
    ...
    onStart() {
        this.log(chalk_1.default.bold(`\nExecution of ${chalk_1.default.blue(this.totalWorkerCnt)} spec files started at`), this.start.toISOString());
        if (this.inDebugMode) {
    ...
    onSpecRunning(cid) {
        this.onJobComplete(cid, this.jobs.get(cid), 0, chalk_1.default.bold.cyan('RUNNING'));
    }
    onSpecRetry(cid, job, retries) {
        const delayMsg = this.specFileRetriesDelay > 0 ? ` after ${this.specFileRetriesDelay}s` : '';
        this.onJobComplete(cid, job, retries, chalk_1.default.bold(chalk_1.default.yellow('RETRYING') + delayMsg));
    }
    onSpecPass(cid, job, retries) {
        this.onJobComplete(cid, job, retries, chalk_1.default.bold.green('PASSED'));
    }
    onSpecFailure(cid, job, retries) {
        this.onJobComplete(cid, job, retries, chalk_1.default.bold.red('FAILED'));
    }
    onSpecSkip(cid, job) {
    ...
    printSummary() {
        ...
        const skipped = this.skippedSpecs > 0 ? chalk_1.default.gray(this.skippedSpecs, 'skipped') + ', ' : '';
